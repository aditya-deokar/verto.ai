                ...
                <div className="relative z-10 grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-6 mb-20">
                    ...
                    <div className="col-span-1">
                        ...
                        <div className="flex gap-4">
                            <Link href="#" className="text-black/40 dark:text-white/40 hover:text-black dark:hover:text-white transition-colors"><Twitter size={20} /></Link>
                            <Link href="#" className="text-black/40 dark:text-white/40 hover:text-black dark:hover:text-white transition-colors"><Linkedin size={20} /></Link>
                            <Link href="#" className="text-black/40 dark:text-white/40 hover:text-black dark:hover:text-white transition-colors"><Discord size={20} /></Link>
                            <Link href="#" className="text-black/40 dark:text-white/40 hover:text-black dark:hover:text-white transition-colors"><Github size={20} /></Link>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex gap-2">
                            ...
                            />
                            <button className="bg-black dark:bg-white text-white dark:text-black px-5 py-2.5 rounded-xl text-sm font-medium hover:scale-105 transition-transform active:scale-95 font-[family-name:var(--font-inter-tight)]">
                                Subscribe
                            </button>
                        </div>
                    </div>
